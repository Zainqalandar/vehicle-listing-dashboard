            ...
            <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center px-8 gap-4">
                ...
                <div className="flex flex-col md:flex-row items-center gap-4">
                    <div className="flex gap-4">
                        ...
                        <a href="#" className="text-white no-underline transition-colors duration-300 hover:text-blue-400">Terms of Service</a>
                        <a href="#" className="text-white no-underline transition-colors duration-300 hover:text-blue-400">Contact Us</a>
                    </div>
                    <button
                        onClick={toggleTheme}
